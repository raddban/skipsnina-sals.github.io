    ...
    <div class="instagram-feed-area d-flex flex-wrap">
        @foreach($pictures as $picture)
            ...
            <div class="single-instagram">
                <img style="width: 256px; height: 256px;" src={{ URL::to('storage/' . $picture->picture_path)}} alt="">
                <!-- Image Zoom -->
                <a href={{ URL::to('storage/' . $picture->picture_path)}} class="img-zoom" title="Instagram Image">+</a>
            </div>
        @endforeach
    </div>
